...
\begin{table}
	...
	\begin{tabular}{*{2}{c}}
        ...
        $\lambda=$ & nearest clipping plane \\
        $\lambda_f=$ & furthest clipping plane \\
        $\phi=$ & perspective angle \\
	\end{tabular}
...
when doing trilateration for the measurement of the position. As in the
...
(Fig. \ref{fig:walk_to_desired_position}).
Todo. Fig. \ref{fig:walk_to_desired_position} shows the trajectory.
Fig. \ref{fig:walk_to_desired_position_yaw} shows yaw.
Fig. \ref{fig:unicycle_velocities} shows profiles of $v$ and $w$.
\begin{figure}
    \centering
